<div class="quality">
    ...
    <%
        ...
        while(r_set.next())    {
    %>
    <div id="<%= count++ %>" style="height: 60%; position: absolute; width: 90%; visibility: hidden; transition: 4s; margin-left: 5%; padding: 0% 2% 0% 2%; /*background-color: #eee; box-shadow: -5px -5px 10px #eee inset; */ border-radius: 10px; font-family: Arial; color: #ccc; font-size: 1.4em;">
    ...
    <script>
        ...
        setInterval(function () {
            ...
            document.getElementById(flag).style.transition = "1s";
